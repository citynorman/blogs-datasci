...
*How to turn a typical pytorch script into a d6tflow DAG for faster research & development*
...
Below is the pytorch model training DAG for FB DLRM. It shows the training task `TaskModelTrain` with all its dependencies and how the dependencies relate to each other.
